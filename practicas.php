            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <li class="li_ptacticas">
                        ...
                        <div class="ubication"><i class="fa-solid fa-location-dot"></i>
                            <?php echo htmlspecialchars($row['ubicacion']); ?></div>
                        <div class="horas"><i class="fa-solid fa-clock"></i> <?php echo htmlspecialchars($row['horas']); ?>
                        </div>
    ...
    <div class="container">
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-content">
                <p>&copy; 2025 ANDECE - Asociación Nacional de la Industria del Prefabricado de Hormigón. Todos los
                    derechos reservados.</p>
                <p class="footer-note">
                    Esta web está diseñada para inspirar a jóvenes profesionales a unirse al futuro de la construcción
                    sostenible.
                </p>
            </div>
        </div>
